# Generated by Django 4.2.14 on 2026-06-10 05:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('data', '0061_alter_sediment_mediangrainsize_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='IptCrabOccurrenceExtension',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('decimalLongitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True)),
                ('eventDate', models.CharField(max_length=50)),
                ('kingdom', models.CharField(default='Animalia', max_length=255)),
